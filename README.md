# angular-user-mgmt
A simple Angular 15 application with UI for typical user management operations:
...
## This application is designed to be used with [this example backend](https://github.com/glafrance/nodejs-express-mongodb-user-mgmt)
Simply clone the examplae backend repository, and place it in a folder named "server" at the same level as this repositories "client" folder.
...
You'll get errors if you try to use the Angular app as you have not yet started the backend. See [the example backend repository](https://github.com/glafrance/nodejs-express-mongodb-user-mgmt) for instructions on setting up and running the backend.
